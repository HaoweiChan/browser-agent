...
```bash
python3 -m evals.run --suite fast        # offline gate: 182 cases, zero paid calls
...
Latest offline baseline — `evals/report/20260825-172218-fast.json`, with
`evals/report/20260825-172106-invariant.json` and
`evals/report/20260823-164737-live.json`:

```
fast  181/182    invariant  66/67    live  9/9    $0.0000    72.2s
...
|---|---|---|---|---|
| `fast` | 182 | 72.53s | 83.41 | **90s** |
| `invariant` | 67 | 13.85s | 15.93 | **20s** |
...
The eval set is not weak; it is 193 cases (182 of them in the offline gate), it
