...
- Band source — local `fast` at 258 cases, ts `20260828-140749`, **104.72s**, 255/258
...
The cited rows' own results — (restated — `fast`: 258 cases, 255/258) and
...
five — gives 104.72 × 1.15 = 120.43 → **125**, which is exactly the
