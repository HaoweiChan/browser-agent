...
Latest offline baseline — `evals/report/20260824-003136-fast.json`, with
`evals/report/20260824-003025-invariant.json` and
`evals/report/20260823-164737-live.json`:

```
fast  154/154    invariant  59/59    live  9/9    $0.0000    70.8s
...
|---|---|---|---|---|
| `fast` | 154 | 71.42s | 82.13 | **90s** |
| `invariant` | 59 | 14.08s | 16.19 | **20s** |
