...
Latest offline baseline — `evals/report/20260824-020552-fast.json`, with
`evals/report/20260824-020441-invariant.json` and
`evals/report/20260823-164737-live.json`:

```
fast  161/161    invariant  64/64    live  9/9    $0.0000    71.1s
recovery 8/8 verified (14 rungs tried) · mutation 9/11 passed, 6 recovered (5 by relocating)
diagnosis 35/35 · 13 replans
```
