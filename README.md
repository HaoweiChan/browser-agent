...
```bash
python3 -m evals.run --suite fast        # offline gate: 257 cases, zero paid calls
...
Latest offline baseline — `evals/report/20260828-125411-fast.json`, with
`evals/report/20260828-125227-invariant.json` and
`evals/report/20260828-080822-live.json`:

```
fast  255/257    invariant  104/105    live  12/12    $0.0000    103.5s
...
The eval set is not weak; it is 288 cases (257 of them in the offline gate), it
