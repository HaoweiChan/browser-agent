...
- T-R56 — the band subsystem's documents and its own strings say what the code does (2026-08-23) — PR #36, trace in tasks/reviews/pr36-r*.json
- M28 — a verifier-rejected run carries no answer: the page dump stays in evidence, the reason cites it by preview (2026-08-23) — PR #38, trace in tasks/reviews/pr38-r*.json
