...
| T5 | Self-built eval set covering diverse domains and task types | Task 1 ¶2 | `evals/golden/` + `evals/adversarial/`; coverage cells in `docs/evals/evaluation-methodology.md`; case-count matrix with empty cells visible | **evidenced** — 81 cases; coverage cells in `docs/analysis.md` §6 with the empty L3 row shown |
