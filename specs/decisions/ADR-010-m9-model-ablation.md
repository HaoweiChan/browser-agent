...
**Amended by**: ADR-027 (loop-mode model additions are exempt from the price ceiling; the ceiling stays for the ablation arms and for mode B's default), implemented by ADR-028 §8 with the added id's price recorded in the frozen snapshot
