...
173 distinct cases (20 golden + 153 adversarial).
248 browser actions in a `fast` run; **91 of the 162** `fast` cases drive a real Chromium end to end — counted here as
cases that actually recorded browser actions, read out of the committed report
`evals/report/20260824-020148-fast.json` rather than tallied by hand (the
...
170 distinct cases (M32, refreshed from the case files' own `tc`/`level`/`domain`
