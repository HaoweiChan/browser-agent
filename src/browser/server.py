...
const ADRS = [
  ...
  ["040", "Chinese scope screening binds every risky match to a measured informational mention inside a read frame; 登陸/登陆 is blocked when it acts on a website, account, or system"],
