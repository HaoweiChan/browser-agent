...
284 distinct cases (28 golden + 256 adversarial).
465 browser actions in a `fast` run; **165 of the 253** `fast` cases drive a real Chromium end to end — counted here as
cases that actually recorded browser actions, read out of the committed report
`evals/report/20260828-114307-fast.json` rather than tallied by hand (the
