...
(restated — `invariant`: 117 cases, 114/117) — are graded against the bullets they
...
- Band source — local `invariant` at 117 cases, ts `20260830-053008`, **36.37s**, 114/117
  (`evals/report/20260830-053008-invariant.json`; `dirty: true`; the three reds
  are the derived headline, ADR scope and band checks refreshed before the final gate.)
  This short sample derives 45 because 36.37 × 1.15 = 41.83 → **45**, below the
