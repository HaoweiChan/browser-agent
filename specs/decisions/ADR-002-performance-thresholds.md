...
4. **`fast` suite wall clock ≤ 60s.** At ~13s there is room for M3–M4 cases;
   ...
   66.6-68.3s and declared rather than reset; closed at M12 at 56.61s and
   now checked by `fast-wall-clock-budget` — ADR-011.)
