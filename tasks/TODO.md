...
### T-R34 — the published band grades a weaker property than README says it does            [status: todo]
Origin: PR #29 R24
Spec: README.md:98-102 and commit 3699b87's message say `published-band-matches-the-ledger`
enforces "the committed ceiling must be at least the rule applied to the ledger's slowest
