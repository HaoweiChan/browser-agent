...
```bash
python3 -m evals.run --suite fast        # offline gate: 165 cases, zero paid calls
...
The eval set is not weak; it is 176 cases (165 of them in the offline gate), it
