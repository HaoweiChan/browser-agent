...
- Five commits of band bookkeeping across the two passes, none of which changed
  any behaviour or any decision.
...
grows with concurrent PRs rather than with work done. At the time of writing
