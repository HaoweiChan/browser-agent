...
const ADRS = [
  ...
  ["027", "an interviewer mandate makes the per-step agentic loop a deliverable, not an experiment: the model gets called after every action and picks the next one — cost ceilings rise, cost accounting does not"],
